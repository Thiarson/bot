    ...
    return (
        <div className="space-y-6">
            ...
            {Object.entries(skillsByCategory).map(([category, categorySkills]) => (
                <div key={category} className="bg-gray-900 border border-gray-700 rounded-lg p-6">
                    <h3 className="text-lg font-medium text-white mb-4 capitalize">{category} Skills</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {categorySkills.map((skill) => (
                            <div key={skill.id} className="bg-gray-800 border border-gray-600 rounded-lg p-4">
