...
function LoadingModal ({ isLoading, message = 'Processing...' }: PropsType) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 animate-fadeIn">
        <div className="bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl p-8 flex flex-col items-center gap-6 animate-scaleIn">
            {/* Circular Spinner */}
            <div className="relative">
                {/* Outer rotating ring */}
                <div className="w-20 h-20 rounded-full border-4 border-gray-700 border-t-transparent animate-spin"></div>
            ...
            <div className="text-center">
                <p className="text-white font-medium text-lg mb-1">{message}</p>
