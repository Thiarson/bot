    ...
    return (
        <div className="space-y-6">
            ...
            {projects.map((project, index) => (
                <div key={project.id} className="bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg p-6">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2 mb-2">
                            {project.technologies.map((tech, idx) => (
                                <span
                                    key={idx}
                                    className="inline-flex items-center gap-1 bg-purple-100 dark:bg-purple-600/20 text-purple-700 dark:text-purple-300 px-3 py-1 rounded-full text-sm"
                                >
                                    {tech}
                                    <button
                                        onClick={() => {
